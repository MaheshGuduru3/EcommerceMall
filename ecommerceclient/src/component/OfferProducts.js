...
const OfferProducts = () => {
    ...
    <div>    
       <div className='p-6 relative'>   
        <h4 className='w-[90rem] m-auto text-3xl mb-5 font-thin dark:text-white'>Offer Products</h4>
        <div className='w-[90rem] m-auto  min-h-[20rem] flex bg-slate-200 rounded-lg overflow-hidden scroll-smooth slide-img1 dark:bg-slate-800'>
             <div className='p-6'>
                <div className='flex gap-5'>                
                {
                         isLoading  &&
                      
                        <div className='w-[90rem] m-auto flex justify-center dark:text-white'>
         ...
         <div className='w-[92rem] absolute top-44 flex  justify-between '>
